# Generated by Django 5.0 on 2025-02-06 14:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expense_nme', models.CharField(max_length=2055, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invest_project_shortname', models.CharField(max_length=2055, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_name', models.CharField(max_length=2055)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_name', models.TextField(blank=True, null=True)),
                ('construction_cost', models.TextField(blank=True, null=True, verbose_name='Стоимость строительных работ')),
                ('installation_cost', models.TextField(blank=True, null=True, verbose_name='Стоимость монтажных работ')),
                ('equipment_cost', models.TextField(blank=True, null=True, verbose_name='Стоимость оборудования, мебели, инвентаря')),
                ('other_cost', models.TextField(blank=True, null=True, verbose_name='Стоимость прочих затрат')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('epc_costs_id_name', models.CharField(max_length=2055, null=True)),
        ...
        migrations.AddField(
            model_name='expensesbyepc',
            name='expense_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expensesbyepc', to='myapp.expenses'),
        ),
        migrations.AddField(
            model_name='expensesbyepc',
        ...
        migrations.AddField(
            model_name='expenses',
            name='local_cost_estimate_id',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.localcostestimate'),
        ),
        migrations.AddField(
            model_name='localestimatedata',
            name='local_cost_estimate_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='parsed_data', to='myapp.localcostestimate'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='localestimatedatasort_2',
            name='local_cost_estimate',
        ...
        migrations.AddField(
            model_name='expenses',
            name='summary_estimate_calculation_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='expenses', to='myapp.summaryestimatecalculation'),
        ),
        migrations.AddField(
