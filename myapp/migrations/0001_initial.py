    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expenses_to_epc_map_id', models.IntegerField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary_estimate_calculation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.summaryestimatecalculation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_cost_estimate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.objectcostestimate')),
                ('summary_estimate_calculation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.summaryestimatecalculation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_cost', models.TextField(blank=True, null=True, verbose_name='Общая сметная стоимость')),
                ('chapter_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.dictsecchapter')),
                ('local_cost_estimate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.localcostestimate')),
                ('object_cost_estimate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.objectcostestimate')),
                ('summary_estimate_calculation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.summaryestimatecalculation')),
            ],
            options={
